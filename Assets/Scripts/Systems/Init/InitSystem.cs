...
public sealed class InitSystem : IInitializeSystem
{
    ...
    public void Initialize()
    {
        foreach (var slot in _config.Slots)
        {
            ...
            e.AddNewCell(slot.Cell.genome, 0, _config.StartEnergy, new Color(slot.Cell.red, slot.Cell.green, slot.Cell.blue), (int)slot.Cell.rot, new Vector2i(slot.Position));
        }
    }
}
