...
public partial class GameEntity {
    ...
    public void AddView(UnityEngine.GameObject newGameObject, UnityEngine.SpriteRenderer newRenderer) {
    ...
    public void ReplaceView(UnityEngine.GameObject newGameObject, UnityEngine.SpriteRenderer newRenderer) {
        var index = GameComponentsLookup.View;
        var component = CreateComponent<ViewComponent>(index);
        component.gameObject = newGameObject;
        component.renderer = newRenderer;
